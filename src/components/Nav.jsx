...
const Nav = () => {
    ...
    const nav = windowWidth <= 768 && <button onClick={() => setMenuOpen(!menuOpen)}>
        {menuOpen ? <div className='fixed z-10 right-4 top-6 ' ><svg width="32" height="31" xmlns="http://www.w3.org/2000/svg"><g fill="#00001A" fill-rule="evenodd"><path d="m2.919.297 28.284 28.284-2.122 2.122L.797 2.419z"/><path d="M.797 28.581 29.081.297l2.122 2.122L2.919 30.703z"/></g></svg></div>
 : <div className='fixed z-10 right-4 top-6 ' ><svg width="40" height="17" xmlns="http://www.w3.org/2000/svg"><g fill="#00001A" fill-rule="evenodd"><path d="M0 0h40v3H0zM0 7h40v3H0zM0 14h40v3H0z"/><path d="M0 0h40v3H0z"/></g></svg></div>
  } 
    </button>
    ...
    return (
        <div className='h-20 py-20 flex items-center md:w-full xl:h-36'>
